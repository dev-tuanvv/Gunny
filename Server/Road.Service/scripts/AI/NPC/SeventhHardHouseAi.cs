    ...
    public class SeventhHardHouseAi : ABrain
    {
        ...
        public void CreateNpc1()
        {
            ...
            if (m_countCall_Npc1 > 0)
            {
                ...
                {
                    ((SimpleBoss)Body).CreateChild(npcID, 596, 955, 1, 1, true, ((PVEGame)Game).BaseLivingConfig());
                }
            }
        ...
        public void CreateNpc2()
        {
            ...
            if (m_countCall_Npc2 > 0)
            {
                ...
                {
                    ((SimpleBoss)Body).CreateChild(npcID2, 792 + (i * 50), 950, 1, 1, true, ((PVEGame)Game).BaseLivingConfig());
                }
            }
        }
    }
