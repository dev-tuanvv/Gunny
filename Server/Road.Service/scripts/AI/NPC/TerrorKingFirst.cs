    ...
    public class TerrorKingFirst : ABrain
    {
        ...
        private void NextAttack()
        {
            ...
            if (target != null)
            {
                ...
                if (Body.ShootPoint(target.X, target.Y, 61, 1000, 10000, 1, 2f, 2300))
                {
                    Body.PlayMovie("beat2", 1500, 0);
                }

                if (Body.ShootPoint(target.X, target.Y, 61, 1000, 10000, 1, 2f, 4100))
                {
                    Body.PlayMovie("beat2", 3300, 0);
                }
				
				if (Body.ShootPoint(target.X, target.Y, 61, 1000, 10000, 1, 2f, 5900))
                {
