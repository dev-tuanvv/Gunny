...
namespace GameServerScript.AI.Messions
{
  public class TVN12101 : AMissionControl
  {
    ...
    public override void OnPrepareNewSession()
    {
      ...
      int[] npcIds = { 12101, 12102, 12103, 12104 };
    ...
    public override void OnStartGame()
    {
      ...
      {
        if (index < 1)
          SomeNpc.Add(Game.CreateNpc(12101, 1360, 700, -1, 1));
        else if (index < 3)
          SomeNpc.Add(Game.CreateNpc(12101, 1410, 700, -1, 1));
        else
          SomeNpc.Add(Game.CreateNpc(12102, 1250, 700, -1, 1));
      }
      npc = Game.CreateNpc(12104, 150, 700, -1, -1);
      ...
      if (Game.TurnIndex > 1 && Game.CurrentPlayer.Delay > Game.PveGameDelay)
      {
        for (int index = 0; index < 4; ++index)
        {
          if (turnCount < 12)
          {
            ++turnCount;
            if (index < 1)
              SomeNpc.Add(Game.CreateNpc(12101, 1260, 700, -1, 1));
            else if (index < 3)
              SomeNpc.Add(Game.CreateNpc(12101, 1350, 700, -1, 1));
            else
              SomeNpc.Add(Game.CreateNpc(12102, 1400, 700, -1, 1));
          }
        }
      }
      if (Game.TurnIndex != 2)
