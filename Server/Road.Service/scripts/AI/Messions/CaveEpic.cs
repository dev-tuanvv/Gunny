...
{
    public class CaveEpic : AMissionControl
    {
        private List<SimpleNpc> someNpc = new List<SimpleNpc>();

        private int dieRedCount = 0;

        private int[] npcIDs = { 85000, 85001, 85002 };
        ...
        public override void OnPrepareNewSession()
        {
            ...
            int[] resources = { npcIDs[0], npcIDs[1], npcIDs[2] };
            int[] gameOverResources = { npcIDs[1], npcIDs[0], npcIDs[0], npcIDs[0], npcIDs[2] };
