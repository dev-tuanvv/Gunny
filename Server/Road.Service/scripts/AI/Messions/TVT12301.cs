...
namespace GameServerScript.AI.Messions
{
  public class TVT12301 : AMissionControl
  {
    ...
    public override void OnPrepareNewSession()
    {
      ...
      int[] npcIds = { 12301, 12302, 12303, 12304 };
    ...
    public override void OnStartGame()
    {
      ...
      {
        if (index < 1)
          SomeNpc.Add(Game.CreateNpc(12301, 1360, 700, -1, 1));
        else if (index < 3)
          SomeNpc.Add(Game.CreateNpc(12301, 1410, 700, -1, 1));
        else
          SomeNpc.Add(Game.CreateNpc(12302, 1250, 700, -1, 1));
      }
      npc = Game.CreateNpc(12304, 150, 700, -1, -1);
      ...
      if (Game.TurnIndex > 1 && Game.CurrentPlayer.Delay > Game.PveGameDelay)
      {
        for (int index = 0; index < 4; ++index)
        {
          if (turnCount < 12)
          {
            ++turnCount;
            if (index < 1)
              SomeNpc.Add(Game.CreateNpc(12301, 1260, 700, -1, 1));
            else if (index < 3)
              SomeNpc.Add(Game.CreateNpc(12301, 1350, 700, -1, 1));
            else
              SomeNpc.Add(Game.CreateNpc(12302, 1400, 700, -1, 1));
          }
        }
      }
      if (Game.TurnIndex != 2)
