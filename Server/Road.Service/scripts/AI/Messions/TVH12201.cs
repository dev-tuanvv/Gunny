...
namespace GameServerScript.AI.Messions
{
  public class TVH12201 : AMissionControl
  {
    ...
    public override void OnPrepareNewSession()
    {
      ...
      int[] npcIds = { 12201, 12202, 12203, 12204 };
    ...
    public override void OnStartGame()
    {
      ...
      {
        if (index < 1)
          SomeNpc.Add(Game.CreateNpc(12201, 1360, 700, -1, 1));
        else if (index < 3)
          SomeNpc.Add(Game.CreateNpc(12201, 1410, 700, -1, 1));
        else
          SomeNpc.Add(Game.CreateNpc(12202, 1250, 700, -1, 1));
      }
      npc = Game.CreateNpc(12204, 150, 700, -1, -1);
      ...
      if (Game.TurnIndex > 1 && Game.CurrentPlayer.Delay > Game.PveGameDelay)
      {
        for (int index = 0; index < 4; ++index)
        {
          if (turnCount < 12)
          {
            ++turnCount;
            if (index < 1)
              SomeNpc.Add(Game.CreateNpc(12201, 1260, 700, -1, 1));
            else if (index < 3)
              SomeNpc.Add(Game.CreateNpc(12201, 1350, 700, -1, 1));
            else
              SomeNpc.Add(Game.CreateNpc(12202, 1400, 700, -1, 1));
          }
        }
      }
      if (Game.TurnIndex != 2)
