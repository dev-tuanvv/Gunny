<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pay.aspx.cs" Inherits="Tank.SNSAssistant.Pay" %>
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td valign="top"><table width="775" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                点劵，需要花费<div id="AccountCount" style="display:inline">1</div>百度币。</label></td>
              </tr>
              <tr>
                <td height="40">&nbsp;</td>
  ...
  <tr>
    <td id="Td1" width="132" height="40" runat="server"><a href="#" target="_self" onClick="Charge_Submit();"><img src="images/dj_icon.jpg" width="124" height="40" border="0"></a></td>
    <td width="132"><a href=""><img src="images/pay_icon.jpg" width="124" height="40" border="0"></a></td>
  </tr>
</table></td>
              </tr>
              <tr>
                <td height="36">&nbsp;</td>
                <td><div class="pay_no" id="pay_no" style="display:none;">百度币不足，请充值百度币！</div></td>
