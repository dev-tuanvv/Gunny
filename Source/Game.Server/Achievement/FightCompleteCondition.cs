namespace Game.Server.Achievement
{
    ...
    {
        public FightCompleteCondition(BaseAchievement quest, AchievementCondictionInfo info, int value) : base(quest, info, value)
        {
        ...
        {
            if (abstractGame_0.RoomType == eRoomType.Match)
            {
                int num = base.Value;
                base.Value = num + 1;
            }
