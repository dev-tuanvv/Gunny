...
{
    public class SimpleSaveBoss : TurnedLiving
    {
        ...
        public SimpleSaveBoss(int id, BaseGame game, NpcInfo npcInfo, int direction, int type, string actions, int mau)
            : base(id, game, npcInfo.Camp, npcInfo.Name, npcInfo.ModelID, npcInfo.Blood, npcInfo.Immunity, direction)
        {
            ...
            if (this.m_ai == null)
            {
                SimpleSaveBoss.log.ErrorFormat("Can't create abrain :{0}", npcInfo.Script);
            ...
            {
                SimpleSaveBoss.log.ErrorFormat("SimpleSaveBoss Created error:{1}", ex);
            }
        }
        ...
        public override void PrepareNewTurn()
        {
            ...
            {
                SimpleSaveBoss.log.ErrorFormat("SimpleSaveBoss BeginNewTurn error:{1}", ex);
            }
        }
        ...
        public override void PrepareSelfTurn()
        {
            ...
            {
                SimpleSaveBoss.log.ErrorFormat("SimpleSaveBoss BeginSelfTurn error:{1}", ex);
            }
        }
        ...
        public override void StartAttacking()
        {
            ...
            {
                SimpleSaveBoss.log.ErrorFormat("SimpleSaveBoss StartAttacking error:{1}", ex);
            }
            if (base.IsAttacking)
            {
                this.StopAttacking();
        ...
        public override void StopAttacking()
        {
            ...
            {
                SimpleSaveBoss.log.ErrorFormat("SimpleSaveBoss StopAttacking error:{1}", ex);
            }
        }
        ...
        public override void Dispose()
        {
            ...
            {
                SimpleSaveBoss.log.ErrorFormat("SimpleSaveBoss Dispose error:{1}", ex);
            }
        }
    }
}