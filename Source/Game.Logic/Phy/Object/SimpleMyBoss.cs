namespace Game.Logic.Phy.Object
{
    ...
    public class SimpleMyBoss : Living
    {
        ...
        public SimpleMyBoss(int id, BaseGame game, NpcInfo npcInfo, int direction, int type) : base(id, game, npcInfo.Camp, npcInfo.Name, npcInfo.ModelID, npcInfo.Blood, npcInfo.Immunity, direction)
        {
            ...
            {
                log.ErrorFormat("SimpleMyBoss Created error:{1}", exception);
            }
        }
        ...
        public override void Dispose()
        {
            ...
            {
                log.ErrorFormat("SimpleMyBoss Dispose error:{1}", exception);
            }
        }
        ...
        public override void PrepareNewTurn()
        {
            ...
            {
                log.ErrorFormat("SimpleMyBoss BeginNewTurn error:{1}", exception);
            }
        }
        ...
        public override void StartAttacking()
        {
            ...
            {
                log.ErrorFormat("SimpleMyBoss StartAttacking error:{1}", exception);
            }
        }
