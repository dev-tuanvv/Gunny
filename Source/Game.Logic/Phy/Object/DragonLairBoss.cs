namespace Game.Logic.Phy.Object
{
    ...
    public class DragonLairBoss : TurnedLiving
    {
    ...
    private SqlDataProvider.Data.NpcInfo m_npcInfo;
        ...
        public DragonLairBoss(int id, BaseGame game, SqlDataProvider.Data.NpcInfo npcInfo, int direction, int type, string action)
