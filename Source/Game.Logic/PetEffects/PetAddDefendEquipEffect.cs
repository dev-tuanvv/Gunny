namespace Game.Logic.PetEffects
{
    ...
    public class PetAddDefendEquipEffect : BasePetEffect
    {
        ...
        public PetAddDefendEquipEffect(int count, int probability, int type, int skillId, int delay, string elementID) : base(ePetEffectType.PetDefendEquipEffect, elementID)
        {
            this.m_count = count;
