namespace Game.Logic.PetEffects
{
    ...
    public class PetAddLuckLimitTurnEquipEffect : BasePetEffect
    {
        ...
        public PetAddLuckLimitTurnEquipEffect(int count, int probability, int type, int skillId, int delay, string elementID) : base(ePetEffectType.PetAddLuckLimitTurnEquipEffect, elementID)
        {
            this.m_count = count;
        ...
        private void player_AfterKilledByLiving(Living living)
        {
            ...
            {
                new PetAddLuckEquip(this.m_count, this.m_currentId, base.Info.ID.ToString()).Start(living);
            }
        }
