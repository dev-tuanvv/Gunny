...
namespace GameServerScript.AI.Messions
{
    public class DCR5302 : AMissionControl
    {
        ...
        private void CreateBossAndNpc()
        {
            ...
            m_boss = Game.CreateBoss(bossId, 1478, 596, -1, 1, "born", Game.BaseLivingConfig());
            ...
            // left npc
            m_npcLeft = Game.CreateBoss(npcLeftId, 1323, 663, -1, 1, "", Game.BaseLivingConfig());
            ...
            m_npcRight = Game.CreateBoss(npcRightId, 1664, 532, -1, 1, "", Game.BaseLivingConfig());
