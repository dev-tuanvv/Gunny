    ...
    public class ConsortiaApplyUsersList : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                {
                    ConsortiaApplyUserInfo[] infoArray = bussiness.GetConsortiaApplyUserPage(num2, num3, ref num, num4, num5, num6, num7);
                    foreach (ConsortiaApplyUserInfo info in infoArray)
                    {
                        element.Add(FlashUtils.CreateConsortiaApplyUserInfo(info));
                    }
                    flag = true;
                    str = "Success!";
                }
